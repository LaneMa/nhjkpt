package org.framework.core.constant;
...
public final class Globals {
	...
	public static Short Log_Leavel_ERROR=3;
	 ...
	 static{
		 String button_authority = ResourceUtil.getSessionattachmenttitle("button.authority.nhjkpt");
		 if("true".equals(button_authority)){
