...
@Component("udpServerLight")  
public class UdpServerLight {  
    ...
    private static final Logger logger = Logger.getLogger(UdpServerLight.class  
            .getName());  
    ...
    public void start() {  
        ...
        {  
            ...
            {  
                ...
                pipleline.addLast("handler", lightHandler);  
                return pipleline;  
            }  
  
        });  
        
        int udpPort=Integer.valueOf(ResourceUtil.getConfigByName("udpPortLight"));
