...
@Component("udpServerGateway")  
public class UdpServerGateway {  
    ...
    private static final Logger logger = Logger.getLogger(UdpServerGateway.class  
            .getName());  
    ...
    public void start() {  
        ...
        {  
            ...
            {  
                ...
                pipleline.addLast("handler", gatewayHandler);  
                return pipleline;  
            }  
  
        });  
        
        int udpPort=Integer.valueOf(ResourceUtil.getConfigByName("udpPortGateway"));
