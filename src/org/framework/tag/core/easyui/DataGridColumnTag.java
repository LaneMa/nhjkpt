...
public class DataGridColumnTag extends TagSupport {
	...
	protected String editor;	//数据字典组编码
	...
	public int doEndTag() throws JspTagException {
		...
		parent.setColumn(title,field,width,rowspan,colspan,align,sortable,checkbox,formatter,hidden,replace,treefield,image,query,url,funname,arg,queryMode, dictionary,frozenColumn,editor);
		return EVAL_PAGE;
	}
