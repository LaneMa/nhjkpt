package nhjkpt.configmanage.page.metershowhistory;
...
public class MeterShowHistoryPage implements java.io.Serializable {
	/**保存-瞬时基本信息*/
	private List<MeterFuncShowHistoryEntity> meterFuncShowHistoryList = new ArrayList<MeterFuncShowHistoryEntity>();
	public List<MeterFuncShowHistoryEntity> getMeterFuncShowHistoryList() {
		return meterFuncShowHistoryList;
	}
	public void setMeterFuncShowHistoryList(List<MeterFuncShowHistoryEntity> meterFuncShowHistoryList) {
		this.meterFuncShowHistoryList = meterFuncShowHistoryList;
	}
