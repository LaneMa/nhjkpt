package nhjkpt.configmanage.entity.departmenthoursum;
 ...
 */
@Entity
@Table(name = "departmenthoursum", schema = "")
@SuppressWarnings("serial")
public class DepartmentHourSumEntity implements java.io.Serializable {
	/**主键*/
