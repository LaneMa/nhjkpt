package nhjkpt.configmanage.entity.buildingmonthsum;
 ...
 * @author qf
 * @date 2013-08-02 00:56:30
 * @version V1.0   
 *
 */
@Entity
@Table(name = "buildingmonthsum", schema = "")
@SuppressWarnings("serial")
public class BuildingMonthSumEntity implements java.io.Serializable {
	/**主键id*/
	...
	public BuildingMonthSumEntity(){
		super();
	}
	public BuildingMonthSumEntity(String buildingid,Date receivetime,Double data){
		super();
		this.buildingid=buildingid;
		this.receivetime=receivetime;
		this.data=data;
	}
	public BuildingMonthSumEntity(String funcid,String buildingid,Date receivetime,Double data){
		super();
		this.funcid=funcid;
		this.buildingid=buildingid;
		this.receivetime=receivetime;
