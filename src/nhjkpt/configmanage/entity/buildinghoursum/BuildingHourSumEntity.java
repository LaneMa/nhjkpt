package nhjkpt.configmanage.entity.buildinghoursum;
 ...
 */
@Entity
@Table(name = "buildinghoursum", schema = "")
@SuppressWarnings("serial")
public class BuildingHourSumEntity implements java.io.Serializable {
	/**主键*/
	...
	public BuildingHourSumEntity(){
		super();
	}
	public BuildingHourSumEntity(Date receivetime,Double data){
		super();
