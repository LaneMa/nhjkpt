package nhjkpt.configmanage.entity.departmentdaysum;
 ...
 */
@Entity
@Table(name = "departmentdaysum", schema = "")
@SuppressWarnings("serial")
public class DepartmentDaySumEntity implements java.io.Serializable {
	/**主键*/
