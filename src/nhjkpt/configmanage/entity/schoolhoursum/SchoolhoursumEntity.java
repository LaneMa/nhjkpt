package nhjkpt.configmanage.entity.schoolhoursum;
 ...
 */
@Entity
@Table(name = "schoolhoursum", schema = "")
@SuppressWarnings("serial")
public class SchoolhoursumEntity implements java.io.Serializable {
	/**主键id*/
	...
	public SchoolhoursumEntity(){
		super();
	}
	public SchoolhoursumEntity(Date receivetime,Double data){
		super();
