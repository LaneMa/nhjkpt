package nhjkpt.configmanage.entity.schoolhouritemize;
 ...
 */
@Entity
@Table(name = "schoolhouritemize", schema = "")
@SuppressWarnings("serial")
public class SchoolHourItemizeEntity implements java.io.Serializable {
	/**主键id*/
	...
	public SchoolHourItemizeEntity(){
		super();
	}
	public SchoolHourItemizeEntity(Date receivetime,Double data){
		super();
