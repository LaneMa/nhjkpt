package nhjkpt.configmanage.entity.schooldaysum;
 ...
 */
@Entity
@Table(name = "schooldaysum", schema = "")
@SuppressWarnings("serial")
public class SchooldaysumEntity implements java.io.Serializable {
	/**主键*/
	...
	public SchooldaysumEntity(){
		super();
	}
	public SchooldaysumEntity(Date receivetime,Double data){
		super();
