package nhjkpt.configmanage.entity.buildingdayitemize;
 ...
 * @author qf
 * @date 2013-08-17 23:12:54
 * @version V1.0   
 *
 */
@Entity
@Table(name = "buildingdayitemize", schema = "")
@SuppressWarnings("serial")
public class BuildingDayItemizeEntity implements java.io.Serializable {
	/**主键*/
	...
	public BuildingDayItemizeEntity(){
		super();
	}
	public BuildingDayItemizeEntity(Date receivetime,Double data){
		super();
