package nhjkpt.configmanage.entity.schoolmonthitemize;
 ...
 */
@Entity
@Table(name = "schoolmonthitemize", schema = "")
@SuppressWarnings("serial")
public class SchoolMonthItemizeEntity implements java.io.Serializable {
	/**主键id*/
	...
	public SchoolMonthItemizeEntity(){
		super();
	}
	public SchoolMonthItemizeEntity(Date receivetime,Double data){
		super();
		this.receivetime=receivetime;
		this.data=data;
	}
	public SchoolMonthItemizeEntity(String itemizeid,Date receivetime,Double data){
		super();
		this.itemizeid=itemizeid;
		this.receivetime=receivetime;
		this.data=data;
	}
	public SchoolMonthItemizeEntity(String itemizeid,Double data){
		super();
		this.itemizeid=itemizeid;
		this.data=data;
	}
