package nhjkpt.configmanage.entity.departmenthouritemize;
 ...
 */
@Entity
@Table(name = "departmenthouritemize", schema = "")
@SuppressWarnings("serial")
public class DepartmentHourItemizeEntity implements java.io.Serializable {
	/**主键*/
