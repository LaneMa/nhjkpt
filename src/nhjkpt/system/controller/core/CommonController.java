...
import org.framework.core.util.ImportUtil;
import org.framework.core.util.JSONHelper;
...
public class CommonController extends BaseController {
	...
	public ModelAndView openViewFile(HttpServletRequest request) {
		...
		String subclassname = oConvertUtils.getString(request.getParameter("subclassname"), "com.nhjkpt.base.pojo.TSAttachment");
