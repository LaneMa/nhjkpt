...
<t:datagrid name="functionList" title="菜单管理" actionUrl="functionController.do?functionGrid" idField="id" treegrid="true" pagination="false" onDblClick="setoper(rowIndex,rowData);">
...
function setoper(rowIndex,rowData){
	operationDetail(rowIndex.id);
}
</script>
<%--   update-end--Author:anchao  Date:20130415 for：按钮权限控制--%>
