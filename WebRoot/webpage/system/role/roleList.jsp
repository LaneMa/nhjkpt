...
<div class="easyui-layout" fit="true" >
 <div region="center" style="padding: 1px;">
  <t:datagrid name="roleList" title="角色列表" actionUrl="roleController.do?roleGrid" idField="id" onDblClick="setfun(rowIndex,rowData);">
...
function setfun(rowIndex,rowData){
	setfunbyrole(rowData.id,rowData.roleName);
}
//----------------------------------------------------------------
//删除角色
function delRole(id){
