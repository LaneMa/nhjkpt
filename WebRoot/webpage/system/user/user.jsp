 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser">
   ...
   <table style="width:600px;" cellpadding="0" cellspacing="1" class="formtable">
    ...
    <tr>
		<td align="right"><label class="Validform_label">学校:</label></td>
		<td class="value">
		 <input name="schoolid" id="schoolid" type="hidden" value="${user.schoolid}"> 
		 <input name="schoolname" id="schoolname" class="inputxt" value="${schoolname }" readonly="readonly" ignore="ignore"/> 
		 <t:choose hiddenName="schoolid" hiddenid="id" url="schoolinfoController.do?schools" name="schoolList" icon="icon-choose" title="学校列表" textname="schoolname" fun="isChooseOne"></t:choose> 
