...
#login .logo {
 ...
 <body>
  ...
  <div id="login">
   ...
   <div class="inner">
    <div class="logo">
     <img src="plug-in/login/images/toplogo-nhjkpt.png"/>
    </div>
    <div class="formLogin">
     <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
      ...
      <div class="tip">
       <input class="password" name="password" type="password" id="password" title="密码" iscookie="true" value="" nullmsg="请输入密码!"/>
      </div>
