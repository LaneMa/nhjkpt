...
<script type="text/javascript">
	$(function() {
		$(document).ready(function() {
			var url="schoolItemizeController.do?queryBroswerBarPie&itemizeid=${itemizeid}";
			//loadDataSum(url);
	...
	function doSubmitSum(){
		var url="schoolItemizeController.do?queryBroswerBarPie&itemizeid=${itemizeid}&type="+$("#schoolItemizePietype").val()+"&startDate="+$("#schoolItemizePiestartDate").val()+"&endDate="+$("#schoolItemizePieendDate").val();
		//loadDataSum(url);
		loadDataByAjax(url,"schoolItemizePie","学校用能统计饼状图","日期","用能","饼状图");
	}
</script>
