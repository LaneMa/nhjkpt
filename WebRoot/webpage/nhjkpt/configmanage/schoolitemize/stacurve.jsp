...
<script type="text/javascript">
	$(function() {
		$(document).ready(function() {
			var url="schoolItemizeController.do?queryBroswerBar";
			//loadDataSum(url);
			loadDataByAjax(url,"schoolItemizeline","学校用能统计曲线","日期","用能","折线图");
		});
	});
	...
	function doSubmitSum(){
		var url="schoolItemizeController.do?queryBroswerBar&itemizeid="+$("#schoolitemizeidhidden").val()+"&type="+$("#daytype").val()+"&startDate="+$("#startDate").val()+"&endDate="+$("#endDate").val();
		//loadDataSum(url);
		loadDataByAjax(url,"schoolItemizeline","学校用能统计曲线","日期","用能","折线图");
	}
</script>
...
<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable" style="overflow-y: hidden" scroll="no">
	<tr>
		...
		<td class="value">
			<t:comboTree url="itemizeController.do?itemizeTree" name="itemizeid" id="schoolitemizeid"></t:comboTree> 
...
<div id="schoolItemizeline" style="width:100%; height:80%"></div>
</html>