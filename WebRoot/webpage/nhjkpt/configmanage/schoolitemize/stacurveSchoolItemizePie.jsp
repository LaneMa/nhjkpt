...
<script type="text/javascript">
	$(function() {
		$(document).ready(function() {
			var url="schoolItemizeController.do?queryBroswerBarSchoolItemizePie";
			//loadDataSum(url);
			loadDataByAjax(url,"schoolItemizePie","学校用能统计饼状图(千瓦时)","日期","用能","饼状图");
		});
	});
	...
	function doSubmitItemize(){
		var url="schoolItemizeController.do?queryBroswerBarSchoolItemizePie&itemizeid="+$("#schoolItemizeidPie").val()+"&type="+$("#schoolItemizePietype").val()+"&startDate="+$("#schoolItemizePiestartDate").val()+"&endDate="+$("#schoolItemizePieendDate").val();
		//loadDataSum(url);
		loadDataByAjax(url,"schoolItemizePie","学校用能统计饼状图(千瓦时)","日期","用能","饼状图");
	}
</script>
...
<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable" style="overflow-y: hidden" scroll="no">
	<tr>
		...
		<td class="value">
			<select name="itemizeid" id="schoolItemizeidPie">
